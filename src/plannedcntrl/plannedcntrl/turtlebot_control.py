...
class TurtleBotController(Node):
    def __init__(self):
        ...
        self.obstacle_hold_topic = self.get_parameter("obstacle_hold_topic").value
    ...
    def obstacle_hold_callback(self, msg):
        """
        Received from the camera perception node (/obstacle_hold).
        True  → obstacle within safety threshold; stop and wait.
        False → path clear; resume normal navigation.
        """
        if msg.data and not self.obstacle_hold:
